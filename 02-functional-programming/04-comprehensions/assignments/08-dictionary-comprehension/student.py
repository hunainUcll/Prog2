...
## tricky stuff here had to use dict list and set 
def director_to_titles(movies):
    return {director:[movie2.title for movie2 in movies if movie2.director == director] for director in {movie.director for movie in movies }}
